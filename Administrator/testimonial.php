...
<div class="container_wrapper">
    ...
    <div class="home_content">
    	<h2 class="header">Daftar Testimonial</h2>
        <table width="650" border="0" cellpadding="1" cellspacing="0">
        <tr bgcolor="">
        	<th class="table">Nama</th><th class="table">Email</th><th class="table">Alamat</th><th class="table">Pesan</th><th class="table">Aksi</th>
        </tr>
        <?php 
		//pagination
		$line =0;
